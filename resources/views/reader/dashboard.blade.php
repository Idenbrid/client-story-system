<x-app-layout>
    ...
    <style>
        ...
        .dreamit-meta-box-footer a:before {
            position: absolute;
            content: "";
            top: 6px;
            right: -15px;
                                    ...
                                    <div class="dreamit-blog-content">
                                        <div class="dreamit-blog-title">
                                            @if($get->is_read == 0)
                                                <h2>
                                                    <a
                                                        href="{{ route('reader.read.story', ['id' => $get->story->id]) }}">{{ $get->story->title }}</a>
                                                </h2>
                                            @else
                                                <h2 style="font-weight:bold ">{{ $get->story->title }}</h2>
                                            @endif
                                        </div>

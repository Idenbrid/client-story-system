<x-app-layout>
    ...
    <section>
      ...
      <section class="bg-white my-8">
        ...
        <!-- Header Button -->  --}}
        <!-- Form -->
        <form method="POST" action="{{route('user.reader.update',['id'=>$reader->id])}}">
          @csrf
        <div class="max-w-7xl rounded mx-auto py-3 my-3 px-4 sm:px-6 lg:px-4 bg-white">
            <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
                ...
                <input type="text" name="username" value="{{ $reader->username }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Enter Username" / autofocus>
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="text" name="first_name" value="{{ $reader->first_name }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="First Name" />
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="text" name="last_name" value="{{ $reader->last_name }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Last Name" />
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="date" name="dob" value="{{ $reader->dob }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Date of Birth" />
          @if($errors->has('dob'))
          ...
          <div class="max-w-4xl mx-auto my-1 flex  items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="email" name="email" value="{{ $reader->User->email }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Email Address" />
            @if($errors->has('email'))
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <select name="source_id" id="source_id" class="border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full my-2 sm:m-2   sm:w-9/12 px-2 py-1">
              <option value="{{auth()->user()->Manager->Source->source_id}}" selected>{{auth()->user()->Manager->Source->source_name}}</option>
            </select>

    ...
    <section class="bg-white my-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 flex justify-between items-center">
            <h2 class="bg-white text-sky-500 text-4xl">
                {{ __('Source Administrator') }}
            </h2>
            <a href="{{ route('admin.source.create') }}">
                <button
                    class="bg-sky-500 text-white py-1 px-3 rounded outline-none focus:outline-none">{{ __('Add New') }}</button>
            </a>
        </div>
        <!-- Page Heading -->
        <!-- Readers Table Data -->
                        ...
                        @foreach ($admins as $admin)
                            ...
                            <tr
                                ...
                                <td class="flex items-center py-4 px-6 space-x-3">
                                    <a href="{{ route('admin.source.edit', ['id' => $admin->id]) }}"
                                    ...
                                    <a href="{{ route('admin.source.destroy', ['id' => $admin->id]) }}"

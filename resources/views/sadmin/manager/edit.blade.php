<x-app-layout>
    ...
    <section>
      ...
      <section class="bg-white my-8">
        ...
        <!-- Header Button -->  --}}
        <!-- Form -->
        <form method="POST" action="{{route('sadmin.manager.update',['id'=>$manager->id])}}">
          @csrf
        <div class="max-w-7xl rounded mx-auto py-3 my-3 px-4 sm:px-6 lg:px-4 bg-white">
            <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
                ...
                <input type="text" name="username" value="{{ $manager->username }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Enter Username" / autofocus>
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="text" name="first_name" value="{{ $manager->user->first_name }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="First Name" />
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="text" name="last_name" value="{{ $manager->user->last_name }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Last Name" />
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="date" name="dob" value="{{ $manager->dob }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Date of Birth" />
          @if($errors->has('dob'))
          ...
          <div class="max-w-4xl mx-auto my-1 flex  items-start  flex-col sm:flex-row sm:items-center">
            ...
            <input type="email" name="email" value="{{ $manager->user->email }}" class="border border-gray-300 w-full my-2 sm:m-2  sm:w-9/12 px-2 py-1 rounded outline-offset-0 outline-none focus:outline-blue-400" placeholder="Email Address" />
            @if($errors->has('email'))
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <select name="gender" id="gender" class="border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full my-2 sm:m-2   sm:w-9/12 px-2 py-1">
              <option value="0" @if(!$manager->gender)selected @endif>Female</option>
              <option value="1" @if($manager->gender)selected @endif>Male</option>
            </select>
          ...
          <div class="max-w-4xl mx-auto my-1 flex items-start  flex-col sm:flex-row sm:items-center">
            ...
            <select name="source_id" id="source_id" class="border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full my-2 sm:m-2   sm:w-9/12 px-2 py-1">
              <option value="{{trim($manager->source_id)}}" selected>{{$manager->Source->source_name}}</option>
            </select>
